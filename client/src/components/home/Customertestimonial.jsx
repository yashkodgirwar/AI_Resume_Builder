...
const Customertestimonial = () => {
  ...
  return (
    <>
      ...
      <div id='testimonials' className="flex flex-col items-center justify-center gap-12 py-16 px-4 md:px-16 lg:px-24 xl:px-40">
         ...
         <Title title="Don't just take our words" description="See what our satisfied customers have to say about their experience with our resume building service" />
