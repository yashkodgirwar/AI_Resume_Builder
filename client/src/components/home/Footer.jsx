...
const Footer = () => {
  return (
    <>
            ...
            <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text--500 bg-gradient-to-b from-green-500 via-white to-green-50 
py-20 rounded-xl shadow-sm mt-40">
                <div className="flex flex-wrap items-start gap-10 md:gap-[60px] xl:gap-[140px]">
                    <a href="#" className="flex items-center gap-2">
                          <img src="/logo.svg" alt="logo" className='h-11 w-auto'/>
                    </a>
                    <div>
                        <p className="text-slate-20 font-semibold">Product</p>
                    ...
                    <div>
                        <p className="text-slate-20 font-semibold">Resources</p>
                        <ul className="mt-2 space-y-2">
                    ...
                    <div>
                        <p className="text-slate-20 font-semibold">Legal</p>
                        <ul className="mt-2 space-y-2">
