...
const Features = () => {
  ...
  return (
     <div id='features' className="flex flex-col items-center justify-center gap-12 py-16 px-4 md:px-16 lg:px-24 xl:px-40">

         <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10  rounded-full px-6 py-1.5">
         <Zap width={14}/>
         <span>AI-Powered Simple Process</span>

        
            
        </div>
        <Title title='Build Your Resume in Minutes' decription='Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered tools and features' />
